...
#ifndef _CUSTOM_SERVER_PIXEL_BUFFER_H_
#define _CUSTOM_SERVER_PIXEL_BUFFER_H_
...
// as possible.
class CustomServerPixelBuffer {
 public:
  CustomServerPixelBuffer();
  ~CustomServerPixelBuffer();
  ...
  DesktopSize window_size() { return window_size_; }
 ...
 private:
  ...
  RTC_DISALLOW_COPY_AND_ASSIGN(CustomServerPixelBuffer);
};

}  // namespace webrtc

#endif  // _CUSTOM_SERVER_PIXEL_BUFFER_H_
