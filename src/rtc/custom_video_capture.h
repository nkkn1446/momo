...
#ifndef _CUSTOM_VIDEO_CAPTURE
#define _CUSTOM_VIDEO_CAPTURE
...
namespace webrtc {
class CustomVideoCaptureModule : public CustomVideoCaptureImpl {
 public:
  CustomVideoCaptureModule();
  ~CustomVideoCaptureModule() override;
