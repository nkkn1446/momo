...
// is necessary.
class CustomScreenCapturer : public DesktopCapturer,
                          public SharedXDisplay::XEventHandler {
 public:
  CustomScreenCapturer();
  ~CustomScreenCapturer() override;
 ...
 private:
  ...
  RTC_DISALLOW_COPY_AND_ASSIGN(CustomScreenCapturer);
};

}  // namespace webrtc

#endif  // _CUSTOM_SCREEN_CAPTURER
