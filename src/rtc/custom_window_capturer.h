...
#ifndef _CUSTOM_WINDOW_CAPTURER
#define _CUSTOM_WINDOW_CAPTURER
...
class CustomWindowCapturer : public DesktopCapturer,
                          public SharedXDisplay::XEventHandler {
 public:
  explicit CustomWindowCapturer(const DesktopCaptureOptions& options);
  ~CustomWindowCapturer() override;
 ...
 private:
  ...
  RTC_DISALLOW_COPY_AND_ASSIGN(CustomWindowCapturer);
};

}  // namespace webrtc

#endif  // _CUSTOM_WINDOW_CAPTURER
